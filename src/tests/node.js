...
const { JsSignatureProvider } = require('../../dist/alajs-jssig');
const fetch = require('node-fetch');
const { TextEncoder, TextDecoder } = require('util');

const privateKey = '5JuH9fCXmU3xbj8nRmhPZaVrxxXrdPaRmZLW1cznNTmTQR2Kg5Z'; // replace with "bob" account private key
/* new accounts for testing can be created by unlocking a alacli wallet then calling: 
 * 1) alacli create key --to-console (copy this privateKey & publicKey)
 * 2) alacli wallet import 
 * 3) alacli create account bob publicKey
 * 4) alacli create account alice publicKey
 */
